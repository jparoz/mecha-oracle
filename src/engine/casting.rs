...
/// Still requires priority (CR 116.2a). ETB triggered rules_text generated by the land
...
pub fn cast_spell(
    ...
    // CR 603.2: fire SpellCast event for triggered rules_text (e.g. Prowess — CR 702.108a).
...
mod tests {
    ...
    fn make_flash_creature_def() -> CardDefinition {
        CardDefinition {
            ...
            rules_text: vec![RulesText::Active(Rule::Static(StaticAbility::Flash))],
            text_annotations: vec![],
            power: Some(2),
            toughness: Some(2),
            colors: vec![],
